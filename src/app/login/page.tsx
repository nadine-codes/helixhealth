      ...
      <div className="w-full max-w-md">
        ...
        <div className="card p-6">
          <form action={enterDemo}>
            <button
              type="submit"
              className="cta-attn cta-sheen relative w-full overflow-hidden rounded-xl bg-gradient-to-r from-[var(--color-accent)] to-indigo-500 px-4 py-3.5 text-[15px] font-semibold text-white transition hover:-translate-y-0.5 hover:brightness-110 active:scale-[0.99]"
            >
              Enter Demo →
            </button>
          </form>
